                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('maintenance.search') }}" method="post" class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="driver_id" id="driver_id" class="form-select form-select-md mb-3"
                                    aria-label="Large select example">
                                    @foreach ($drivers as $driver)
                                    <option value="{{ $driver->id }}">{{ $driver->first_name." ".$driver->second_name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" name="datedebut" id="validationDefault02"
                                    value="1900-01-01" required>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="datefin" class="form-control"
                                        id="validationDefaultUsername" value="2050-01-01"
